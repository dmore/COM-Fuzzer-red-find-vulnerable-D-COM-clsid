...
.DESCRIPTION
This cmdlet imports a JSON file to Neo4j, will need a json file that was exported by Invoke-ComFuzzer
.PARAMETER jsonFile
Specify the json file that was generated by Invoke-ComFuzzer
.PARAMETER Neo4jHost
